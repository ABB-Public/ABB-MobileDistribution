...
ABB Asea Brown Boveri Ltd and its [subsidiary companies](https://new.abb.com/privacy-policy/subsidiaries) are responsible for your personal data. For applicable data protection law, the controller of your data will be the ABB affiliate which is providing services or communicating to you. Each such entity is regarded as an independent controller of your personal data, and this notice applies to all such companies.

Controllers located outside of the European Union (EU) have appointed a representative for EU data privacy matters. For details about your controller’s EU representative, please submit a request at [www.abb.com/privacy](https://new.abb.com/privacy).

###The personal data we collect about you and how we get it 
We collect the following categories of personal data:

* The contact information you share with us: first name, last name, business email, business telephone number, business mobile number. 
* Employee number 
...
*	claim travel and entertainment expenses; 
*	manage local accounts or your accounts with other ABB group companies; 
*	create personal accounts in applications; 
*	organize workplace management including travel and expense programs and internal health and safety programs.
...
|----|----|----|----|
|ABB affiliates and subsidiaries|	See the list of ABB subsidiaries|The purposes described in this privacy notice|	EU Model Clauses |
...
According to the financial policy, the period of preservation of information is 15 years.
...
You may request to enforce your data privacy rights at [www.abb.com/privacy](https://new.abb.com/privacy). In certain circumstances, we may need to restrict the above rights to safeguard the public interest (e.g., the prevention or detection of crime) or our business interests (e.g., the maintenance of legal privilege).

###Contact and further information 
If you have any questions about how we use your personal data or wish to make a complaint about how we handle it, you may contact our Group Data Protection Officer at <privacy@abb.com>, or submit your complaint at [www.abb.com/privacy](https://new.abb.com/privacy). Should you not be satisfied with our response or believe we are processing your personal data against the law, you may also contact the Data Privacy Authority in your country of residence or work or where you believe an infringement of data privacy laws may have taken place. 
