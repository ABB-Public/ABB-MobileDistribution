...
ABB Oy, Stroembergintie 1, Helsinki, 00380 Finland will be the “Controller” of your personal data – this company is responsible for the privacy of your data.
...
- Log in the user and manage the access 
...
Where it concerns processing operations related to the provision of the service which you have requested] (as described above), ABB will not be able to log you in and generally perform the purposes described above without certain personal data. Although we cannot obligate you to share your personal data with us, please note that this then may have consequences which could affect your employment in a negative manner, such as not being able to perform your’ tasks.  
...
- Necessary for the performance of a contract with Data Subject 
...
We only share your personal data with other ABB affiliates or third parties as necessary for the purposes described in the table below. Where we share your personal data with an affiliate or third party so that it is transferred to or becomes accessible from outside the European Union (“EU”) and the European Economic Area ("EEA") or outside the country where the ABB company that controls your data is located, we always put adequate safeguards in place to protect your personal data. Examples of these safeguards are an adequacy decision of the European Commission ([read more here](https://ec.europa.eu/info/law/law-topic/data-protection/international-dimension-data-protection/adequacy-decisions_en)), Standard Contractual Clauses ([read more here](https://ec.europa.eu/info/law/law-topic/data-protection/international-dimension-data-protection/standard-contractual-clauses-scc_en)), Privacy Shield certification ([read more here](https://ec.europa.eu/info/law/law-topic/data-protection/international-dimension-data-protection/eu-us-data-transfers_en)), and the Binding Corporate Rules that some of our suppliers have adopted ([read more here](https://ec.europa.eu/info/law/law-topic/data-protection/data-transfers-outside-eu/binding-corporate-rules_en)). We have taken additional measures for the transfer of data from within to outside the EU, EEA and outside the country where the ABB company that controls your data is located to protect your personal data. If you would like an overview of the safeguards which are in place, please submit a request at [www.abb.com/privacy](https://new.abb.com/privacy).

Recipient category | Recipient location | Purpose
---|---|---
[ABB affiliates and subsidiaries] | [List of the countries](https://new.abb.com/privacy-policy/subsidiaries) | Described in the Privacy Notice
[ABB customers, business partners, distributors, and agents] | EU/EEA and non-EU/EEA (global) | Described in the Privacy Notice
[Service providers such as IT services, independent agents, HR and training, payroll and payment processors, rating and assessment services, professional and advisory services including accountants, auditors, lawyers, insurers, bankers, recruiters, travel agents] and other advisors or service providers working on ABB’s behalf| EU/EEA and non-EU/EEA (global) | Described in the Privacy Notice
[Insolvency administrators or creditors]|EU/EEA and non-EU/EEA (global)|Described in the Privacy Notice
[Potential or actual acquirers of ABB businesses or assets]|EU/EEA and non-EU/EEA (global)|Described in the Privacy Notice
[Recipients as required by applicable law or legal process, to law enforcement or government authorities, etc.]|EU/EEA and non-EU/EEA (global)|Described in the Privacy Notice



###8.	How long we keep your personal data 
Based on mandatory legislation, ABB must keep certain personal data for a minimum period of time. We only keep your personal data for as long as necessary for the purposes described in this privacy notice. Your personal data will be kept for the time you are employee or contractor of ABB or for longer period only if required by local laws and regulatory requirements.  
