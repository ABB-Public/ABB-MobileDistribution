...
ABB Oy address: Stroembergintie 1, Helsinki 00380, Finland will be the “Controller” of your personal data – this company is responsible for the privacy of your data.
...
First name, last name, business telephone number, business address, business email, analytics data, images.
...
* manage and administer your use of requested applications, products and services
...
Our legitimate interests to collect and use the personal data for this purpose are contact with you to provide product support and manage yours requested questions. You may obtain a copy of our assessment of why we may process your personal data for these interests by visiting [www.abb.com/privacy](http://www.abb.com/privacy)
...
|:------------- |:-------------|:-------------|
| ABB affiliates and subsidiaries | EU/EEA and non-EU/EEA (global) | To provide the product support  |
| Service providers such as IT services working on ABB’s behalf | EU/EEA and non-EU/EEA (global) | To provide the product support |


### 7. How long we keep your personal data  
Based on mandatory legislation, ABB must keep certain personal data for a minimum period of time. We only keep your personal data for as long as necessary for the purposes described in this privacy notice. Your personal data will be kept as long as necessary for the purpose [depends on how long you will use the services] or for longer period only if required by local laws and regulatory requirements.  
...
For more information regarding specific retention periods that apply to your personal data, please submit a request at [www.abb.com/privacy](https://new.abb.com/privacy).
...
| The right to object to the data processing |	You have the right to object to our processing of your personal where we rely on our legitimate interests as the basis for our processing, where your data protection rights outweigh our reasoning for legitimate interests. |
